...
<div class="flex flex-col justify-center items-center gap-2">
    <div class="flex justify-around items-center gap-2">
        ...
        <a href="{{ route('gruponovo') }}" class="bg-emerald-500 hover:bg-emerald-700 rounded-lg py-2 px-5 focus:outline-none focus:ring focus:ring-emerald-300 text-zinc-50 flex items-center mt-4 gap-x-2 justify-center transition duration-300 ease-in-out font-semibold">
        ...
        <tr class="bg-violet-100 even:bg-violet-200">
            ...
            <td class="flex pl-2 pr-1 w-fit py-5 flex-nowrap gap-x-2" scope="col">
                <form method="POST" action="{{ route('grupodelete', ['id'=> $grupo->id]) }}">
                    ...
                    {{ csrf_field()}}
                    <a href="{{ route('grupoform', ['id' => $grupo->id]) }}" class='bg-emerald-500 hover:bg-emerald-700 rounded-full py-2 px-5 focus:outline-none focus:ring focus:ring-emerald-300 text-zinc-50 flex items-center mt-4 gap-x-2 justify-center transition duration-300 ease-in-out'>
