...
<div class="flex flex-col justify-center items-center gap-2 mb-8 grow">
    ...
    <div class="grid grid-cols-6 grid-rows-4 gap-2 pb-8" id="palavras-grid">
        ...
        <script>
            ...
            const url = pagina ? `http://localhost:8000/api/palavras?page=${pagina}` : 'http://localhost:8000/api/palavras'
            console.log(url)
            ...
            .then((data) => {
                document.querySelectorAll('.animate-pulse').forEach(e => {
            ...
            <form method="POST" action="#" class="w-fit mx-auto pt-4">
                <input type="hidden" name="_method" value="DELETE">
                {{ csrf_field()}}
                <div class="flex gap-x-2 items-center">
                    <a href="/palavras/${element.id}"
