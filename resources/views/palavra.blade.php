...
<div class="flex flex-col justify-center items-center gap-2 pt-4 grow bg-violet-50">

    <div class="flex flex-col gap-4 rounded-xl justify-center w-[95%] px-10 bg-zinc-50 shadow shadow-violet-100 py-4">
        ...
        <form action="{{ route('palavrainsert') }}" method="POST">
            ...
            <fieldset class="flex flex-col  p-10 w-[40rem] gap-4 mx-auto">
    ...
    <div class="flex flex-col rounded-xl justify-center w-[95%] px-10 bg-zinc-50 mt-6 shadow shadow-violet-100">
        <div class="rounded-lg overflow-hidden mb-6 mx-auto">
