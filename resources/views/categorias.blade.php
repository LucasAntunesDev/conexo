...
<body class="bg-slate-900 text-zinc-50">
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        <div class="flex justify-around items-center gap-2">
            ...
            <a href="categoria.php" class="bg-emerald-500 rounded-md py-1 px-4 focus:bg-slate-50
        ...
        <tbody class="text-sm bg-neutral-50/40">
            ...
            <tr class="bg-slate-800 even:bg-slate-700">
                ...
                <td class="flex pl-2 pr-1 w-fit py-5 flex-nowrap gap-x-2" scope="col">
                    ...
                    <a href='categoria.php?id={{ $categoria->id }}' class='bg-emerald-500 rounded-full py-1 px-4 focus:bg-slate-50
                    ...
                    <a href='excluirProfessor.php?id={{ $categoria->id }}' class='bg-red-500 rounded-full py-1 px-4 focus:bg-slate-50
